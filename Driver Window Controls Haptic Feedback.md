...
Future enhancements: (a) add a zener diode to stabilize the voltage on the motor for consistent experience (the voltage does fluctuate a bit), (b) graduate for option two in the above table... so we can finally start writing code...
