...
| :------------- | :------------- | :----
| The best way to tap into existing harness is at the connector and insert a new wire with the right pin | Glued with heatconducting epoxy to staty in place | A brand new harness and connector for added wires and wiring changes
