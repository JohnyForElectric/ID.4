...
With ID software version 3.1 the 12V rail is more stable, so an intended Zener diode is not necessary. Was hoping that the id.7 / 20214 ID.4/5 will introduce a 4 switch version and I'd just swap this VW experiment for a real thing. Since that did not happen, I did wrap the handle in VVIVID XPO Black Leather Suede for luxury look. And it really looks great... 

Ok so I feel this is the end of this mod... :) Off to the next one...
